...
3. 후보별로 아래를 작성한다:
   ...
   - 카드뉴스 유형 (채용공고형 / 정보형 / 인터뷰형 등) — "채용공고형"은
     실제 운영 템플릿(무료형/유료형, 카드 1장)이 이미 있으므로
     `slide_outline` 대신 회사명·직무명·담당업무·지원자격·경력/지역/
     고용형태·마감일을 채우는 방식으로 제시한다. 자세한 필드는
     `card-news-designer.md`의 "채용공고형 카드" 절 참고.
